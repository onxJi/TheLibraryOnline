export const BookCover = ({book, currentStatus}) => {
      ...
      <div className="md:w-1/3 p-6 flex-shrink-0">
        ...
        <div className="flex gap-[0.25rem]">
          ...
          {currentStatus === "RENTED" && (
            <span className="inline-block mt-2 text-red-700  text-[0.85rem] px-2 py-1 bg-green-100 shadow-sm transform -skew-x-12 rounded-sm">
              {currentStatus}
            </span>
          )}
        </div>
